...
A powerful and efficient subdomain enumeration script that combines multiple techniques to discover subdomains of a target domain.
...
The following scripts must be installed on your system:

- `subfinder` - Fast passive subdomain enumeration script
- `httpx` - Fast and multi-purpose HTTP scriptkit
...
This script is for educational and authorized security testing purposes only. Always ensure you have proper authorization before testing any domain.
